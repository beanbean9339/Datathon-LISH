...
import { CheckCircle2, Github, FileText, X } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto" ref={ref}>
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Technical projects and case competitions
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {workProjects.map((project, index) => (
              ...
              >
                {/* Glow Effect */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl opacity-0 group-hover:opacity-30 blur transition duration-300" />
        ...
        >
          ...
          >
            ...
            <div className="space-y-8">
              ...
              {/* Links */}
              {(selectedProject.githubUrl || selectedProject.posterUrl) && (
                <div>
                  <h3 className="text-xl font-display font-semibold mb-3 text-foreground">
                    Resources
                  </h3>
                  <div className="flex flex-wrap gap-4">
                    {selectedProject.githubUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium hover:shadow-lg hover:shadow-primary/30 transition-shadow"
                      >
                    ...
                    {selectedProject.posterUrl && (
                      <a
                        href={selectedProject.posterUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-medium hover:shadow-lg hover:shadow-secondary/30 transition-shadow"
                      >
